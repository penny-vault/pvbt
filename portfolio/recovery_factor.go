...
func (recoveryFactor) Compute(a *Account, window *Period) float64 {
	...
	return totalReturn / math.Abs(minDD)
}

func (recoveryFactor) ComputeSeries(a *Account, window *Period) []float64 { return nil }
