...
func (shortProfitFactor) Name() string { return "ShortProfitFactor" }

func (shortProfitFactor) Description() string {
	return "Gross profit divided by gross loss from short round-trip trades only. " +
