	...
	Describe("When given a performance struct", func() {
		Context("with portfolio returns", func() {
			It("should have draw downs", func() {
				...
				Expect(drawDowns[0].Begin).Should(BeEquivalentTo(646815600))
				...
				Expect(drawDowns[1].Begin).Should(BeEquivalentTo(949388400))
				...
				Expect(drawDowns[2].Begin).Should(BeEquivalentTo(1575183600))
				...
				Expect(drawDowns[3].Begin).Should(BeEquivalentTo(1191222000))
				...
				Expect(drawDowns[4].Begin).Should(BeEquivalentTo(1301641200))
				...
				Expect(drawDowns[5].Begin).Should(BeEquivalentTo(896684400))
				...
				Expect(drawDowns[6].Begin).Should(BeEquivalentTo(1270105200))
				...
				Expect(drawDowns[7].Begin).Should(BeEquivalentTo(1143874800))
				...
				Expect(drawDowns[8].Begin).Should(BeEquivalentTo(1430463600))
				...
				Expect(drawDowns[9].Begin).Should(BeEquivalentTo(760086000))
