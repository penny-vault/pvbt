...
- Monte Carlo simulation runs a strategy against thousands of resampled price series to distinguish skill from luck, reporting confidence intervals, probability of ruin, and where the historical result ranks among simulated paths.
