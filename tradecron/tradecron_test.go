...
var _ = Describe("Tradecron", func() {
	...
	DescribeTable("when evaluating next trade day",
		...
		Entry("month begin, only 7th month of the year, 10am, regular hours", "@monthbegin 0 10 * 7", tradecron.RegularHours, time.Date(2022, 7, 1, 10, 0, 0, 0, common.GetTimezone()), time.Date(2023, 7, 3, 10, 0, 0, 0, common.GetTimezone())),
		Entry("month begin, check when for date is 1 minute before required", "@monthbegin */5 10 * 7", tradecron.RegularHours, time.Date(2022, 7, 1, 10, 9, 0, 0, common.GetTimezone()), time.Date(2022, 7, 1, 10, 10, 0, 0, common.GetTimezone())),
		Entry("month begin, check when for date is 1 minute before required", "@monthbegin 0 10 * 7", tradecron.RegularHours, time.Date(2022, 7, 1, 9, 59, 0, 0, common.GetTimezone()), time.Date(2022, 7, 1, 10, 0, 0, 0, common.GetTimezone())),
		Entry("month begin, check when for date is 1 hour before required", "@monthbegin 0 10 * 7", tradecron.RegularHours, time.Date(2022, 7, 1, 9, 0, 0, 0, common.GetTimezone()), time.Date(2022, 7, 1, 10, 0, 0, 0, common.GetTimezone())),
		Entry("month begin, check when for date is 1 hour after required", "@monthbegin 0 10 * 7", tradecron.RegularHours, time.Date(2022, 7, 1, 11, 0, 0, 0, common.GetTimezone()), time.Date(2023, 7, 3, 10, 0, 0, 0, common.GetTimezone())),
		Entry("month begin, check when for date is month begin but time is end of day", "@monthbegin 0 10 * 7", tradecron.RegularHours, time.Date(2022, 7, 1, 23, 0, 0, 0, common.GetTimezone()), time.Date(2023, 7, 3, 10, 0, 0, 0, common.GetTimezone())),
		Entry("month begin, check when for date is 1 trading day after required", "@monthbegin 0 10 * 7", tradecron.RegularHours, time.Date(2022, 7, 4, 11, 0, 0, 0, common.GetTimezone()), time.Date(2023, 7, 3, 10, 0, 0, 0, common.GetTimezone())),
		...
		Entry("month end at 10am", "@monthend 0 10 * *", tradecron.RegularHours, time.Date(2022, 7, 29, 0, 0, 0, 0, common.GetTimezone()), time.Date(2022, 7, 29, 10, 0, 0, 0, common.GetTimezone())),
		Entry("month end at 10am, 1 min before", "@monthend 0 10 * *", tradecron.RegularHours, time.Date(2022, 7, 29, 9, 59, 0, 0, common.GetTimezone()), time.Date(2022, 7, 29, 10, 0, 0, 0, common.GetTimezone())),
		Entry("month end at 10am, on the dot", "@monthend 0 10 * *", tradecron.RegularHours, time.Date(2022, 7, 29, 10, 0, 0, 0, common.GetTimezone()), time.Date(2022, 8, 31, 10, 0, 0, 0, common.GetTimezone())),
		Entry("month end at 10am, 1 min after", "@monthend 0 10 * *", tradecron.RegularHours, time.Date(2022, 7, 29, 10, 1, 0, 0, common.GetTimezone()), time.Date(2022, 8, 31, 10, 0, 0, 0, common.GetTimezone())),
		Entry("month end at 10am, every 5 min, 1 min after", "@monthend */5 10 * *", tradecron.RegularHours, time.Date(2022, 7, 29, 10, 1, 0, 0, common.GetTimezone()), time.Date(2022, 7, 29, 10, 5, 0, 0, common.GetTimezone())),
		Entry("month end at 10am, date after last trading day of month", "@monthend 0 10 * *", tradecron.RegularHours, time.Date(2022, 7, 30, 10, 0, 0, 0, common.GetTimezone()), time.Date(2022, 8, 31, 10, 0, 0, 0, common.GetTimezone())),
		Entry("week begin, july 4th holiday", "@weekbegin", tradecron.RegularHours, time.Date(2022, 7, 4, 0, 0, 0, 0, common.GetTimezone()), time.Date(2022, 7, 5, 9, 30, 0, 0, common.GetTimezone())),
		Entry("week begin, regular", "@weekbegin", tradecron.RegularHours, time.Date(2022, 7, 11, 0, 0, 0, 0, common.GetTimezone()), time.Date(2022, 7, 11, 9, 30, 0, 0, common.GetTimezone())),
		Entry("week begin, at open", " @open @weekbegin", tradecron.RegularHours, time.Date(2022, 7, 11, 9, 30, 0, 0, common.GetTimezone()), time.Date(2022, 7, 18, 9, 30, 0, 0, common.GetTimezone())),
		Entry("week begin, at open, 5 min", "@weekbegin */5", tradecron.RegularHours, time.Date(2022, 7, 11, 9, 30, 0, 0, common.GetTimezone()), time.Date(2022, 7, 11, 9, 35, 0, 0, common.GetTimezone())),
		...
		Entry("week end, at open", "@open @weekend", tradecron.RegularHours, time.Date(2022, 7, 8, 9, 30, 0, 0, common.GetTimezone()), time.Date(2022, 7, 15, 9, 30, 0, 0, common.GetTimezone())),
	)
